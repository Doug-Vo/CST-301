...
messages = [
    {"role": "system",
     "content": "You are attempting to classify the Java classes based on the 31 given options"},
    {"role": "system",
     "content": "Answer in the format of: Class (the given class) - LLM-domain - simulated - Reasoning"}
]
...
def ask_gpt(classes):
    ...
    prompt = "What is the llm domain of: \n"
    for class_info in classes:
        prompt += class_info + ", "
    prompt += "Please only give me one word answer for each classes"
